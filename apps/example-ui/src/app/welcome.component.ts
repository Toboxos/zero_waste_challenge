            ...
            <div class="container">
                ...
                <div id="hero" class="rounded">
                    <div class="text-container">
                        <h2>
                            @if ((apiCall | async)?.message === 'Hello API') {
                            <svg
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            ...
                            <span>Something went wrong. Api call failed</span>
                            }
                        </h2>
...
nx run-many -t build test lint</pre>
                    ...
                    <details>
                        ...
                        <pre>nx show project example-ui</pre>
                    </details>
...
export class WelcomeComponent {
    apiCall = this.httpClient.get<{ message: string }>('/api');
